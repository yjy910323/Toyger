...
public class ScatterData extends Data {
	...
	public ScatterData setValue(List<Integer> data) {
		this.value = data;
		return this;
	}
	
	public ScatterData setValues(Integer... value){
		if(this.value == null){
	...
	public ScatterData setTooltip(Tooltip tooltip) {
	...
	public ScatterData setItemStyle(ItemStyle itemStyle) {
